...
- **Visitor map**: Tracks visitors by country in real time using Cloudflare headers
- **Contact form**: Email delivery via Gmail SMTP with rate limiting and CSRF protection
